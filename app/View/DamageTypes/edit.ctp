...
<?php echo $this->Form->create('DamageType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Damage Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DamageType.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('DamageType.id'))); ?></li>
